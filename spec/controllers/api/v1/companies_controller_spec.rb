...
RSpec.describe Api::V1::CompaniesController, :type => :controller do
  ...
  let(:valid_attributes) {
    {name: 'Some Name', address_attributes: {address1: 'some address', city: 'some city'}}
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        {name: 'Some New Name', address_attributes: {address1: 'some address', city: 'some city'}}
      }
      ...
      it "updates the requested company" do
        ...
        company.reload
        expect(company.name).to eq 'Some New Name'
      end
