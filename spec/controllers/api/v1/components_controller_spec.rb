...
RSpec.describe Api::V1::ComponentsController, :type => :controller do
  ...
  let(:valid_attributes) {
    {name: 'Widget 1', part_number: '123456789', serial_number: 'ABC123456'}
  }

  let(:invalid_attributes) {
    {name: '', part_number: '123456789', serial_number: 'ABC123456'}
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        {name: 'Widget 2', part_number: '223456789', serial_number: 'ABC123457'}
      }
      ...
      it "updates the requested component" do
        ...
        component.reload
        expect(component.name).to eq 'Widget 2'
        expect(component.part_number).to eq '223456789'
        expect(component.serial_number).to eq 'ABC123457'
      end
