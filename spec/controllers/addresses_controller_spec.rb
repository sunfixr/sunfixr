  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        {
            name: "Grandpa",
            address1: "1313.5 Mockingbird ln",
            address2: '#321',
            city: "Hollyweed",
            state: "CA",
            postal_code: "91210",
            latitude: 34.201001,
            longitude: -118.243301,
        }
      }
      ...
      it "updates the requested address" do
        ...
        address.reload
        expect(address.name).to eq 'Grandpa'
        expect(address.address1).to eq "1313.5 Mockingbird ln"
        expect(address.address2).to eq '#321'
        expect(address.postal_code).to eq "91210"
      end
