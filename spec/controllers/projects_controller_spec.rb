  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested project" do
        ...
        expect(project.slug).to eq 'newname'
        expect(project.description).to eq 'Fake description'
        expect(project.install_date).to eq Date.today
        expect(project.address.address1).to eq('some new address')
        expect(project.address.city).to be_nil
      end

      it "assigns a new company" do
        project = Project.create! valid_attributes
        company = Company.create(name: 'Some New Company')
        put :update, {:id => project.to_param, :project => new_attributes.merge(company_id: company.id)}, valid_session
        project.reload
