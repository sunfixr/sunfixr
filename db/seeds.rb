User.create!([
  {email: "admin@sunfixr.com", password: 'bogusmybutt', encrypted_password: "$2a$10$bR.bjZZ8BW3JvPHJJ/CxNu2bjVK9RXWZ9yM24eMdDqq9sl7ebUBQ.", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2015-05-26 22:34:01", last_sign_in_at: "2015-05-26 22:34:01", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", confirmation_token: nil, confirmed_at: "2015-05-26 22:32:45", confirmation_sent_at: "2015-05-26 22:32:04", unconfirmed_email: nil, role: nil, encrypted_authentication_token: "FlsekwJOIUY1zMuVebmNePWkZTi27VijbDPyxC6YRpg=\n", encrypted_authentication_token_salt: nil, encrypted_authentication_token_iv: nil}
  ])
Address.create!([
...
LogEntry.create!([
                     {project: Project.find_by_slug("ditunga"), component_id: "3", user: "Bob", comments: "checked battery water levels"}
                 ])
